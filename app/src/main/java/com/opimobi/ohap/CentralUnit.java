...
public abstract class CentralUnit extends Container {
     ...
     */
    protected abstract void changeBinaryValue(Device device, boolean value) throws IOException;
     ...
     * @param value The new binary value for the device.
     */
    protected abstract void changeDecimalValue(Device device, double value) throws IOException;
     ...
     */
    protected abstract void listeningStateChanged(Container container, boolean listening) throws IOException;
